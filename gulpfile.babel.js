/*
most of this code was informed heavily by alexandro perez's walkthrough!
...
// added src and des paths to files and js bundles handled in tasks
const paths = {
    ...
    js: {
      src: 'src/img/*.js',
      dest: 'dist/',
      // from alexandro perez's walkthrough don't add the src folder to path. Use a path relative to the src folder. Use array even if only one bundle.
  ...
  // all code below taken from alexandro's walkthrough 
